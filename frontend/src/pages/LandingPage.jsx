...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#08070d] text-[#f7f6f0] selection:bg-[#595388] selection:text-[#f7f6f0]">
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/login"
              className="flex items-center gap-2 rounded-xl bg-[#595388] px-4 py-2 text-xs font-bold uppercase tracking-wider text-[#f7f6f0] shadow-lg shadow-[#595388]/30 transition-all duration-300 hover:bg-[#6e67a7] hover:scale-105"
            >
              Host Event
              <ArrowRight size={14} />
            </Link>
      ...
      <section className="relative mx-auto max-w-7xl px-6 pt-32 pb-24 md:pt-44 md:pb-36">
        <div className="grid items-center gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7">
            ...
            >
              Create public or college-exclusive events. From smart registration limits and team
              matchmaking to live agendas and scoring panels, HackFlow runs your entire tech event
              pipeline.
            </motion.p>
            ...
            >
              <Link
                to="/login"
                className="group flex items-center gap-2 rounded-xl bg-[#595388] px-6 py-3.5 text-sm font-bold uppercase tracking-wider text-[#f7f6f0] shadow-xl shadow-[#595388]/30 transition-all duration-300 hover:bg-[#6c65a4] hover:shadow-[#595388]/40 hover:-translate-y-0.5"
              >
                Host an Event
              ...
              <Link
                to="/events"
                className="flex items-center gap-2 rounded-xl border border-[rgba(175,172,202,0.2)] bg-transparent px-6 py-3.5 text-sm font-bold uppercase tracking-wider text-[#f7f6f0] transition-all duration-300 hover:bg-[rgba(175,172,202,0.05)]"
              >
                Explore Hackathons
                <Compass size={14} />
              </Link>
              ...
              <TiltCard className="relative overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-[rgba(175,172,202,0.12)] pb-4">
                  <div className="flex flex-col">
                    <span className="font-display font-bold text-sm text-[#f7f6f0]">
                      Global AI Hackathon 2026
                    </span>
                    <span className="text-[10px] text-[#afacca] mt-0.5">
                      Hosted by IIT Bombay Chapter
                    </span>
                  </div>
                  <span className="rounded-md bg-green-500/15 border border-green-500/30 px-2 py-0.5 font-display text-[9px] text-green-400 font-bold uppercase tracking-wider">
                    ONGOING
                  </span>
                </div>
                ...
                <div className="mt-5 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-lg bg-[#08070d]/50 p-2.5 border border-[rgba(175,172,202,0.05)]">
                      <span className="block text-[9px] text-[#afacca] uppercase tracking-wider">
                        Registration Mode
                      </span>
                      <span className="text-xs font-bold text-[#f7f6f0] mt-1 block">
                        Hybrid Venue
                      </span>
                    </div>
                    <div className="rounded-lg bg-[#08070d]/50 p-2.5 border border-[rgba(175,172,202,0.05)]">
                  ...
                  <div className="rounded-lg bg-[#08070d]/90 p-4 border border-[rgba(175,172,202,0.08)]">
                    <span className="block text-[9px] font-bold text-[#afacca] uppercase tracking-widest mb-2.5">
                      Active Itinerary Timeline
                    </span>
      ...
      <section
        id="features"
        className="mx-auto max-w-7xl px-6 py-24 border-t border-[rgba(175,172,202,0.05)]"
      >
        <motion.div {...fadeInUp} className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[#afacca]">
            A SaaS command center equipping event hosts with custom registrations, team management,
            and scoring structures.
          </p>
        </motion.div>
        ...
        >
          <motion.div variants={fadeInUp} className="glass-card glass-card-hover rounded-2xl p-6">
            ...
            <h3 className="mt-5 font-display text-xl font-bold text-[#f7f6f0]">
              Easy Event Hosting
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-[#afacca]">
              Set up detailed descriptions, category tags, banner images, and ticketing settings
          ...
          <motion.div variants={fadeInUp} className="glass-card glass-card-hover rounded-2xl p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[#afacca]">
              Form teams or find team builders. Group participants together and control member
          ...
          <motion.div variants={fadeInUp} className="glass-card glass-card-hover rounded-2xl p-6">
            ...
            <h3 className="mt-5 font-display text-xl font-bold text-[#f7f6f0]">
              Digital Venue Channels
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-[#afacca]">
              Configure platform meeting links (Zoom, Google Meet, Discord) and organize direct
              lounge pathways for mentors and speakers.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="glass-card glass-card-hover rounded-2xl p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[#afacca]">
              Keep everyone on schedule with live itineraries, speaker alerts, and calendar links
              embedded into the hacker workspace.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="glass-card glass-card-hover rounded-2xl p-6">
            ...
            <h3 className="mt-5 font-display text-xl font-bold text-[#f7f6f0]">
              Exclusive College Portals
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-[#afacca]">
              Toggle visibility parameters to restrict registrations to pre-approved university
              domains or specific colleges.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="glass-card glass-card-hover rounded-2xl p-6">
            ...
            <h3 className="mt-5 font-display text-xl font-bold text-[#f7f6f0]">
              Judging & Grading Panel
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-[#afacca]">
              Add designated judges who can evaluate final submissions and assign scoring values
              inside the secure HackFlow portal.
            </p>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-lg text-[#afacca]">
            Launch customizable workspaces, invite judges, and manage registrations. No fee
            required.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <Link
              to="/login"
              className="flex items-center gap-2 rounded-xl bg-[#595388] px-6 py-3 text-sm font-bold uppercase tracking-wider text-[#f7f6f0] transition-all duration-300 hover:bg-[#6a63a0] hover:scale-105"
            >
      ...
      <footer className="border-t border-[rgba(175,172,202,0.05)] py-12">
        <div className="mx-auto max-w-7xl px-6 flex flex-col items-between gap-6 md:flex-row md:justify-between text-xs text-[#afacca]">
          <div>
            <p className="font-semibold text-[#f7f6f0]">
              © 2026 HackFlow Inc. All rights reserved.
            </p>
            <p className="mt-1">Designed for university, community, and corporate hackathons.</p>
          </div>
          <div className="flex gap-6">
            <a href="#" className="hover:text-[#f7f6f0]">
              Terms
            </a>
            <a href="#" className="hover:text-[#f7f6f0]">
              Privacy
